...
const Sidebar = () => {
  ...
  const toggleEnergyDropdown = () => {
    setEnergyDropdownOpen(!energyDropdownOpen);
  };
  return (
    <div
      style={{ display: "flex", height: "140vh", overflow: "scroll initial" }}
    >
      <CDBSidebar textColor="#fff" backgroundColor="#333">
        <CDBSidebarHeader prefix={<i className="fa fa-bars fa-large"></i>}>
          <img src="https://github.com/santoshsen96/edyoda/assets/112757984/6955cbc9-f73e-4ab1-9d46-cfea78aab63b" />
        </CDBSidebarHeader>
        ...
        <CDBSidebarContent className="sidebar-content">
          <CDBSidebarMenu>
            <CDBSidebarMenuItem>
              <div style={{ display: "flex", gap: "5%", marginLeft: "2%" }}>
                ...
                <div className="energy-text" onClick={toggleEnergyDropdown}>
                  Energy
                </div>
                {energyDropdownOpen && (
                  <div className="energy-dropdownn">
                    <select>
          ...
          <div style={{ width: "100%", margin: "auto", textAlign: "center" }}>
            <Button variant="info">Open Help Center</Button>{" "}
          </div>
        </CDBSidebarContent>
      </CDBSidebar>
    </div>
